---
name: pace
description: Sector deltas, lap-time trends, session-best comparison — trigger every lap and on pace anomalies.
---
...
- A lap within ±0.2 s of recent average is normal — write a one-line
  write a note to `learnings/pace-<topic>.md` ("lap N: …") and stop.
